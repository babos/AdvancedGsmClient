...
#define ADVGSM_LOG( severity, tag, format, ... ) if (AdvancedGsmLog.Log != nullptr && severity < ADVGSM_LOG_LEVEL) { \
    AdvancedGsmLog.Log->printf("<%d>X %d %s ", 16 * 8 + severity, millis(), tag); \
